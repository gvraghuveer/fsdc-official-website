...
const TeamPage = () => {
  ...
  const coreTeam = [
    ...
    { name: "G V Raghuveer", role: "Media Head", img: "" },
    { name: "Maurthi L", role: "Design Head", img: "" },
    { name: "Shreya K", role: "NaN", img: "" },
    { name: "Jyoti P Netrakar", role: "NaN", img: "" },
  ];
        ...
        <div className="relative z-10 max-w-7xl mx-auto px-6 lg:px-12">
          ...
          <section className="text-center mb-16">
            <RevealOnScroll>
              ...
              <div className="h-1.5 w-24 bg-purple-600 mx-auto rounded-full shadow-[0_0_20px_#a855f7] mt-4" />
            </RevealOnScroll>
          </section>
          ...
          <section className="mb-48 relative group/swiper">
            <RevealOnScroll delay="300ms">
              ...
              <Swiper
                ...
                className="team-swiper cursor-grab active:cursor-grabbing"
              >
                {coreTeam.map((member, idx) => (
                  <SwiperSlide key={idx}>
                    <ProfileCard name={member.name} role={member.role} image={getAssetUrl("team", member.img)} />
                  </SwiperSlide>
                ))}
              </Swiper>
          ...
          <section className="relative">
            <RevealOnScroll>
              <div className="text-center mb-20">
                ...
                <h2 className="text-4xl md:text-6xl font-black italic uppercase text-white inline-block relative">
                ...
                <p className="mt-6 text-gray-500 text-xs tracking-widest uppercase font-medium max-w-lg mx-auto leading-relaxed">
                  Supported by the School of CSE, our mentors provide the strategic vision for technical excellence.
                </p>
              </div>
            </RevealOnScroll>
